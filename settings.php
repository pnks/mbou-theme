...
if (is_siteadmin()) {
    ...
    $ADMIN->add('themes', new admin_category('theme_mbou', 'MBO Utrecht'));

    
    // Header Settings 
    $temp = new admin_settingpage('theme_mbou_header', get_string('generalheading', 'theme_klass'));
    ...
    // Front Page Settings 
    $temp = new admin_settingpage('theme_mbou_frontpage', get_string('frontpageheading', 'theme_klass'));
    ...
    $temp = new admin_settingpage('theme_mbou_slideshow', get_string('slideshowheading', 'theme_klass'));
    $temp->add(new admin_setting_heading('theme_mbou_slideshow', get_string('slideshowheadingsub', 'theme_klass'),
    ...
    $temp = new admin_settingpage('theme_mbou_footer', get_string('footerheading', 'theme_klass'));
